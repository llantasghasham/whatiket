...
contactRoutes.post("/contacts/:contactId/files", isAuth, upload.array("files"), ContactController.uploadContactFiles);
contactRoutes.delete("/contacts/:contactId/files", isAuth, ContactController.deleteContactFile);
