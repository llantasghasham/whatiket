...
const SyncEventService_1 = __importDefault(require("../GoogleCalendar/SyncEventService"));
const UpdateUserService = async ({ scheduleData, id, companyId }) => {
    ...
    console.log("UpdateService - chamando SyncEventService para schedule", schedule.id, "companyId:", companyId);
    await (0, SyncEventService_1.default)({ schedule: schedule });
    console.log("UpdateService - SyncEventService finalizado para schedule", schedule.id);
    return schedule;
};
