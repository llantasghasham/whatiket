...
const DeleteSliderHomeService = async ({ id, companyId }) => {
    if (companyId !== 1) {
        throw new AppError_1.default("Apenas a empresa mestre pode remover banners", 403);
    }
...
exports.default = DeleteSliderHomeService;
