...
const TicketTagController = __importStar(require("../controllers/TicketTagController"));
const ticketTagRoutes = express_1.default.Router();
...
ticketTagRoutes.delete("/ticket-tags/:ticketId/:tagId", isAuth_1.default, TicketTagController.remove);
