...
const TutorialVideoController = __importStar(require("../controllers/TutorialVideoController"));
const tutorialVideoRoutes = express_1.default.Router();
// Middleware de autenticação para todas as rotas
tutorialVideoRoutes.use(isAuth_1.default);
...
exports.default = tutorialVideoRoutes;
