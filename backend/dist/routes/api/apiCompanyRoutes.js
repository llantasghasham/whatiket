...
const GooglePlacesController = __importStar(require("../../controllers/api/GooglePlacesController"));
...
// COMPANY (com autenticação via token da empresa)
...
// COMPANY - endpoint público simples para criação de empresas (sem autenticação)
// Útil para integrar outros sistemas que precisam apenas cadastrar uma nova company.
apiCompanyRoutes.post("/public/companies", CompanyController.store);
// GOOGLE PLACES - busca pública de empresas por cidade/estado e filtros
apiCompanyRoutes.get("/public/google-places/search", GooglePlacesController.search);
