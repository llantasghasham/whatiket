...
userRoutes.get("/users/2fa/setup", isAuth_1.default, UserController.setup2FA);
userRoutes.post("/users/2fa/confirm", isAuth_1.default, UserController.confirm2FA);
userRoutes.post("/users/2fa/disable", isAuth_1.default, UserController.disable2FA);
userRoutes.delete("/users/:userId/2fa", isAuth_1.default, UserController.adminDisable2FA);
