...
const loadBaileys_1 = require("../utils/loadBaileys");
    ...
    return new Promise(async (resolve, reject) => {
        try {
            (async () => {
                ...
                const baileys = await (0, loadBaileys_1.loadBaileys)();
                const { default: makeWASocket, Browsers, DisconnectReason, fetchLatestBaileysVersion, isJidBroadcast, isJidGroup, jidNormalizedUser, makeCacheableSignalKeyStore, proto } = baileys;
