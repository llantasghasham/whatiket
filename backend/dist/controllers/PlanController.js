...
const ListPublicPlansSimpleService_1 = __importDefault(require("../services/PlanService/ListPublicPlansSimpleService"));
...
exports.list = list;
const listPublicSimple = async (_req, res) => {
    const plans = await (0, ListPublicPlansSimpleService_1.default)();
    return res.status(200).json(plans);
};
