...
const store = async (req, res) => {
    const { body, sendAt, contactId, userId, ticketUserId, queueId, openTicket, statusTicket, whatsappId, intervalo = 1, valorIntervalo = 0, enviarQuantasVezes = 1, tipoDias = 4, contadorEnvio = 0, assinar = false } = req.body;
    const { companyId } = req.user;
    console.log("ScheduleController.store - criando schedule", "companyId:", companyId, "contactId:", contactId, "sendAt:", sendAt);
