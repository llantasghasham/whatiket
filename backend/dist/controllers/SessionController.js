...
exports.remove = exports.me = exports.update = exports.verify2FA = exports.store = void 0;
const AppError_1 = __importDefault(require("../errors/AppError"));
const socket_1 = require("../libs/socket");
const AuthUserService_1 = __importDefault(require("../services/UserServices/AuthUserService"));
const Verify2FAService_1 = __importDefault(require("../services/UserServices/Verify2FAService"));
...
const store = async (req, res) => {
    ...
    const result = await (0, AuthUserService_1.default)({
        email,
        password
    });
...
const verify2FA = async (req, res) => {
    ...
    const { token, serializedUser, refreshToken } = await (0, Verify2FAService_1.default)({
        email,
