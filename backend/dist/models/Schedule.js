...
__decorate([
    ...
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "ticketUserId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => User_1.default, "ticketUserId"),
    __metadata("design:type", User_1.default)
], Schedule.prototype, "ticketUser", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => Queue_1.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "queueId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Queue_1.default),
    __metadata("design:type", Queue_1.default)
], Schedule.prototype, "queue", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ defaultValue: "closed" }),
    __metadata("design:type", String)
], Schedule.prototype, "statusTicket", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ defaultValue: "disabled" }),
    __metadata("design:type", String)
], Schedule.prototype, "openTicket", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", String)
...
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", String)
], Schedule.prototype, "googleEventId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => Whatsapp_1.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "whatsappId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Whatsapp_1.default),
    __metadata("design:type", Whatsapp_1.default)
], Schedule.prototype, "whatsapp", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "intervalo", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "valorIntervalo", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "enviarQuantasVezes", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "tipoDias", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], Schedule.prototype, "contadorEnvio", void 0);
__decorate([
    (0, sequelize_typescript_1.Default)(false),
    sequelize_typescript_1.Column,
    __metadata("design:type", Boolean)
], Schedule.prototype, "assinar", void 0);
Schedule = __decorate([
