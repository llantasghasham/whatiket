        ...
        <>
          ...
          <Paper className={classes.mainPaper} elevation={1}>
            ...
            >
              ...
              {isSuper() ? <Tab label="Ayudas" value={"helps"} /> : null}
              {isSuper() ? <Tab label="Whitelabel" value={"whitelabel"} /> : null}
              {isSuper() ? <Tab label="Certificado efímero PIX" value={"uploadercert"} /> : null}
              {isSuper() ? <Tab label="Registro" value={"cadastro"} /> : null} {/* Nueva pestaña */}
            </Tabs>
