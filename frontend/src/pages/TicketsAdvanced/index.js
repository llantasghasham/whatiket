...
const TicketAdvanced = (props) => {
    ...
    const renderPlaceholder = () => {
        return <Box className={classes.placeholderContainer}>
            <div className={classes.placeholderItem}>Selecciona un ticket para comenzar la conversación</div><br />
            <Button
               onClick={() => setOption(1)}
               variant="contained"
               startIcon={<CheckIcon />}
            ...
            <TicketAdvancedLayout>
                <Box className={classes.header}>
                    ...
                    >
                        ...
                        <BottomNavigationAction label="Atenciones" icon={<QuestionAnswerIcon />} />
                    </BottomNavigation>
                </Box>
