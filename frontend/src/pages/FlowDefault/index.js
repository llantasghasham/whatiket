  ...
  const handleSaveDefault = async () => {
    ...
    if (configExist) {
      try {
        ...
        toast.success("Flujos estándar actualizados");
      } catch (err) {
        toastError(err);
      }
    } else {
        ...
        <Stack sx={{ padding: '12px', position: 'relative' }}>
          ...
          <Stack gap={'12px'}>
            ...
            <Typography fontSize={12}>
              Este flujo se activa solo para nuevos contactos, personas que no tienes
              en tu lista de contactos y que enviaron un mensaje
            </Typography>
          ...
          <Stack gap={'12px'} marginTop={4}>
            <Typography fontSize={18} fontWeight={700}>Flujo de respuesta estándar</Typography>
            <Typography fontSize={12}>
              La Respuesta Estándar se envía con cualquier carácter diferente de una palabra clave. ¡ATENCIÓN! Se activará si la atención ya está cerrada y han pasado 6 horas desde su cierre.
            </Typography>
            {!loading && (<Autocomplete
              disablePortal
              id="combo-box-demo"
