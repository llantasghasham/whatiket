        ...
        <Grid item xs={12} sm={6} md={4} key={key}>
          <Card className={classes.card} style={rowStyle(row)}>
            <CardContent className={classes.cardContent}>
              ...
              <Typography variant="body2" component="p" className={classes.smallText}>
                <strong>Plan:</strong> {renderPlan(row)}
              </Typography>
              <Typography variant="body2" component="p" className={classes.smallText}>
                <strong>Valor:</strong> {i18n.t("compaies.table.money")} {renderPlanValue(row)}
              </Typography>
              <Typography variant="body2" component="p" className={classes.smallText}>
                <strong>Activo:</strong> {renderStatus(row)}
              </Typography>
              <Typography variant="body2" component="p" className={classes.smallText}>
                <strong>Creado el:</strong> {dateToClient(row.createdAt)}
              </Typography>
              <Typography variant="body2" component="p" className={classes.smallText}>
                <strong>Vencimiento:</strong> {dateToClient(row.dueDate)} <br />
                <span>{row.recurrence}</span>
              </Typography>
              <Typography variant="body2" component="p" className={classes.smallText}>
                <strong>Último inicio de sesión:</strong> {datetimeToClient(row.lastLogin)}
              </Typography>
            </CardContent>
