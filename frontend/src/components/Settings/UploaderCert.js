...
const handleFileChange = (event) => {
  ...
  if (selectedFile) {
    ...
    if (fileName.endsWith(".p12")) {
      ...
      toast.error("Utiliza solo archivos en formato .p12.");
    }
  }
};
...
return (
  <>
    <Grid spacing={3} container>
      ...
      >
        <Tab label="Certificado efímero - API PIX (p12)" />
      </Tabs>
      ...
      <form onSubmit={handleSubmit} className={classes.fullWidth}>
          ...
          <FormControl className={classes.selectContainer}>
            <InputLabel id="selectOption-label">Elige una opción:</InputLabel>
            <Select
            ...
            >
              <MenuItem value="certificadoEfi">Certificado efímero p12 API PIX</MenuItem>
            </Select>
          </FormControl>
        </Grid>
        ...
        <Grid item xs={12} sm={12} md={12} style={{ display: 'flex' }}>
            ...
            <label className={classes.fileInputLabel}>
              ...
              />
              {selectedFileName ? selectedFileName : 'Elegir certificado'}
            </label>
          </FormControl>
        </Grid>
