...
export default function Options(props) {
  ...
  // OPENAI API KEY TRANSCRIPCIÓN DE AUDIO
    ...
    <>
      <Grid spacing={3} container>
        ...
        {isSuper() ? (
          <Grid item xs={12}>
            <FormControl className={classes.selectContainer} style={{ backgroundColor: "white" }}>
              <InputLabel id="downloadLimit-label">Límite de descarga de archivos (MB)</InputLabel>
              <Select
              ...
              <FormHelperText>{loadingDownloadLimit && "Actualizando..."}</FormHelperText>
            </FormControl>
          </Grid>
        ) : null}
      ...
      <Grid spacing={3} container>
        {isSuper() ? (
          <Tabs
            ...
            style={{ marginBottom: 20, marginTop: 20, backgroundColor: "#444394", color: "white" }}
          >
            <Tab label='OpenAI API KEY Transcripción de audio (Para todas empresas)' />
          </Tabs>
        ) : null}
      </Grid>
