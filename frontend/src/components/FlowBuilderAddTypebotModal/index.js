...
const FlowBuilderTypebotModal = ({ open, onSave, data, onUpdate, close }) => {
  ...
  const [labels, setLabels] = useState({
    title: "Agregar Typebot al flujo",
    btn: "Agregar",
  });
  ...
  useEffect(() => {
    if (open === "edit") {
      setLabels({
        title: "Editar Typebot del flujo",
        btn: "Guardar",
      });
    ...
    <div className={classes.root}>
      ...
      >
        <DialogTitle id="form-dialog-title">
          {open === "create" ? `Agregar Typebot al flujo` : `Editar Typebot`}
        </DialogTitle>
        <Formik
                  ...
                  <Grid container spacing={1}>
                    <>
                      ...
                      <Grid item xs={12} md={6} xl={6}>
                        <Field
                          as={TextField}
                          label="Retraso de Mensaje Typebot"
                      ...
                      <Grid item xs={12} md={6} xl={6}>
                        <Field
                          as={TextField}
                          label="Palabra Clave de Finalización"
                      ...
                      <Grid item xs={12} md={6} xl={6}>
                        <Field
                          as={TextField}
                          label="Palabra Clave de Reinicio"
