                      ...
                      <div className={classes.fieldWithIcon}>
                        ...
                        >
                          ...
                          <Select
                            ...
                            <MenuItem value={null} >{"Deshabilitado"}</MenuItem>
                  ...
                  <>
                    ...
                    >
                      <DialogContent className={classes.dialogContent}>
                        ...
                        <p>Este flujo se dispara solo para nuevos contactos, personas que no posees en tu lista de contactos y que enviaron un mensaje</p>
                        <FormControl
                          variant="outlined"
                          margin="dense"
                          className={classes.FormControl}
                      ...
                      <DialogContent className={classes.dialogContent}>
                        ...
                        <p>La Respuesta Estándar se envía con cualquier carácter diferente de una palabra clave. ¡ATENCIÓN! Se disparará si la atención ya está cerrada.</p>
                        <FormControl
                          variant="outlined"
                          margin="dense"
                          className={classes.FormControl}
