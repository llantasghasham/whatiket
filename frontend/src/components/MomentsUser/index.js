...
const DashboardManage = () => {
        ...
        <DialogContent className={classes.dialogContent}>
          ...
          {ticket.unreadMessages > 0 && (
            <div className={classes.dialogSection}>
              ...
              <Typography variant="body1" className={classes.dialogValue}>
                {ticket.unreadMessages} mensaje(s) no leído(s)
              </Typography>
            </div>
          )}
        </DialogContent>
  ...
  const Moments = useMemo(() => {
    ...
    if (tickets && tickets.length > 0) {
      ...
      return (
        <Box className={classes.emptyState}>
          <Typography variant="body1">Ningún ticket encontrado</Typography>
        </Box>
      );
    }
  }, [update, loading]);
        ...
        <Paper className={classes.userCard}>
          <div className={classes.cardHeaderPending}>
            <CardHeader
              ...
              subheader={
                <Typography className={classes.ticketCount}>
                  {`${pendingTickets.length} atenciones sin responsable`}
                </Typography>
              }
              action={
                <Button 
        ...
        {tickets.length > 0 && (
          <Paper className={classes.statsCard}>
            <div className={classes.statsContainer}>
              ...
              <div className={classes.statItem}>
                <Typography className={classes.statLabel}>Asignados</Typography>
                <Typography className={classes.statValue}>{getAssignedTicketsCount()}</Typography>
              </div>
              <div className={classes.statItem}>
                <Typography className={classes.statLabel}>Pendientes</Typography>
