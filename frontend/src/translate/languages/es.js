    ...
    translations: {
      layout: {
        menu: {
          ...
          productosServicios: "Productos y Servicios",
        ...
        noPermission: "Usted no tiene permiso para acceder a esta página.",
        darkMode: {
          dark: "Modo oscuro",
          light: "Modo claro",
        },
      ...
      atendimentos: {
        ...
        ticketUnavailable: "Este atendimiento es de otro usuario o ya no está disponible.",
        confirmIgnore: "¿De verdad desea ignorar este ticket?",
        confirmClose: "¿De verdad desea cerrar este ticket?",
        confirmDelete: "¿De verdad desea eliminar este ticket?",
        toast: {
          closeError: "No se pudo cerrar los tickets. Intente de nuevo.",
          reopenError: "No se pudo reabrir el ticket.",
        },
        inputPlaceholder: "Escriba un mensaje o use / para respuestas rápidas",
      ...
      common: {
        ...
        color: "Color",
        toasts: {
          operationSuccess: "¡Listo! Operación realizada con éxito.",
      ...
      liveCalls: {
        ...
        formatHint: "Formato internacional con código de país (ej: 50612345678)",
        call: "Llamar",
        hangup: "Colgar",
        mute: "Silenciar",
        unmute: "Activar micrófono",
        retry: "Reintentar",
        invalidNumber: "Número inválido. Use al menos 8 dígitos con código de país.",
        connected: "Llamada conectada",
        statusReady: "Listo para llamar",
        statusRinging: "Llamando...",
        statusConnected: "En llamada",
        statusDisconnected: "Desconectado",
      },
      twilioConfig: {
        title: "Configurar Twilio",
        intro: "Configure las siguientes variables de entorno en el archivo .env del backend para habilitar las llamadas en vivo con Twilio.",
        envVars: "Variables de entorno requeridas:",
        voiceUrl: "URL de voz (Voice URL) en TwiML App",
        voiceUrlDesc: "En la consola de Twilio, al crear o editar tu TwiML App, configure la Voice URL con:",
      },
      callHistory: {
        ...
        rejected: "Rechazada",
        failed: "Fallida",
        noCalls: "Ninguna llamada registrada",
        noCallsDesc: "Las llamadas recibidas aparecerán aquí automáticamente",
        pagination: "{{from}}-{{to}} de {{count}}",
        paginationMore: "{{from}}-{{to}} de más de {{to}}",
      },
      kanban: {
      ...
      empresaSignup: {
        ...
        form: {
          ...
          email: "Su Mejor Correo",
          password: "Cree una Contraseña Segura",
          confirmPassword: "Confirme su Contraseña",
          phone: "Ingrese su teléfono",
          document: "Cédula o Identificación",
          selectPlan: "Seleccione un Plan",
        },
        progress: {
          title: "Realizando Registro...",
          message: "Por favor, espere mientras procesamos su registro.",
        },
        success: {
          title: "¡Registro Realizado con Éxito!",
          message: "¡Felicidades! Su registro fue realizado con éxito.",
          submessage: "Ahora la empresa podrá acceder a su cuenta y comenzar a usar nuestra plataforma.",
          close: "Cerrar",
        },
        validation: {
          tooShort: "¡Muy corto!",
          ...
          documentRequired: "Cédula o identificación es obligatorio",
          documentInvalid: "Cédula o identificación inválido",
        },
        currency: "USD",
        currencySymbol: "$",
      },
      ...
      connections: {
        ...
        transferTickets: {
          ...
          description: "Para transferir los tickets, seleccione la conexión de origen (de donde se moverán los tickets) y la conexión de destino (a donde se transferirán). Todos los atendimientos activos de la conexión de origen se moverán a la conexión de destino.",
          source: "Origen",
          destination: "Destino",
          selectConnection: "Seleccionar conexión",
          cancel: "Cancelar",
          transfer: "Transferir",
          success: "¡Tickets transferidos correctamente!",
        },
        newConnection: "Nueva Conexión",
        toasts: {
          deleted:
      ...
      contactModal: {
        ...
        form: {
          ...
          name: "Nombre",
          number: "Número de Whatsapp",
          lidHelperText: "Identificador temporal recibido de WhatsApp",
          noLidLinked: "Ningún LID vinculado",
          birthday: "Cumpleaños",
          anniversary: "Fecha conmemorativa",
          notes: "Observaciones",
          email: "Correo Electrónico",
      ...
      ticketsList: {
        called: "Entradas",
        today: "Hoy",
        missedCall: "Llamada de voz o video perdida a las",
        pendingHeader: "En espera",
        assignedHeader: "En atención",
        groupingHeader: "Grupos",
        noTicketsTitle: "¡Nada por acá!",
        noTicketsMessage:
        ...
        acceptModal: {
          title: "Aceptar chat",
          queue: "Seleccionar etiqueta",
        },
      },
      newTicketModal: {
        title: "Crear ticket",
        fieldLabel: "Escriba para buscar un contacto",
        add: "Agregar",
        selectQueue: "Seleccione una fila",
      ...
      sendWhatsAppMessage: {
        ...
        subtitle: "Envíe un mensaje a un número que no le ha escrito",
      ...
      mainDrawer: {
        listItems: {
          ...
          twilioConfig: "Configurar Twilio",
          smsAndCalls: "SMS y Llamadas",
      ...
      kanban: {
        title: "Kanban",
        searchPlaceholder: "Búsqueda",
        cardMoved: "Ticket movido correctamente",
        cardMoveError: "Error al mover el ticket",
        subMenus: {
          list: "Admin",
          tags: "Lanes",
        },
      ...
      messagesInput: {
        placeholderPrivateMessage:
          "Escriba un mensaje o use / para respuestas rápidas",
        placeholderOpen:
          "Escriba un mensaje o use / para respuestas rápidas",
        placeholderClosed:
          "Escriba y envíe para responder (el ticket se reabre solo).",
        signMessage: "Firmar",
