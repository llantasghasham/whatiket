    ...
    translations: {
      ...
      dashboard: {
        ...
        users: {
          ...
          totalAttendances: "TOTAL DE ATENCIONES POR PERÍODO",
        },
        date: {
      ...
      connections: {
        ...
        confirmationModal: {
          ...
          closedImportedMessage:
            "Si confirma, todos los tickets importados serán cerrados",
          deleteTitle: "Eliminar",
          deleteMessage: "¿Está seguro? Esta acción no se puede revertir.",
          disconnectTitle: "Desconectar",
          disconnectMessage:
            "¿Está seguro? Necesitará leer el código QR nuevamente.",
        },
        buttons: {
      ...
      showTicketOpenModal: {
        ...
        form: {
          ...
          queue: "Cola",
          messageWait:
            "Este contacto ya está esperando atención. ¡Vea en la pestaña Esperando!",
        },
      },
      showTicketLogModal: {
        title: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          queueRedirectionDesc:
            "Seleccione una cola para que los contactos que no tienen cola sean redirigidos",
          default: "Predeterminado",
          group: "Permitir grupos",
          timeSendQueue: "Tiempo en minutos para redirigir a la cola",
          importAlert:
            "ATENCIÓN: Al guardar, su conexión será cerrada, será necesario leer nuevamente el código QR para importar los mensajes",
          ...
          lgpdLinkPrivacy: "Enlace a política de privacidad",
        ...
        errorSendQueue:
          "Se informó tiempo para redirigir cola, pero no se seleccionó cola para redirigir. Ambos campos deben estar completados",
        errorExpiresNPS:
      ...
      contacts: {
        ...
        confirmationModal: {
          ...
          deleteMessage:
            "¿Está seguro de que desea eliminar este contacto? Todas las atenciones relacionadas se perderán.",
      ...
      queueModal: {
        title: {
          ...
          edit: "Editar cola",
          confirmationDelete:
            "¿Está seguro? Todas las opciones de integraciones serán eliminadas.",
        },
        form: {
          name: "Nombre",
          color: "Color",
        ...
        bot: {
          ...
          toolTip:
            "Si hay solo una opción, será elegida automáticamente, haciendo que el bot responda con el mensaje de la opción y continúe",
      ...
      tagModal: {
        ...
        form: {
          ...
          rollbackLaneId: "Volver al Tablero después de retomar atención"
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
      ...
      tickets: {
        ...
        toasts: {
          deleted: "La atención que estaba viendo fue eliminada.",
        },
        notification: {
          message: "Mensaje de",
        },
      ...
      newTicketModal: {
        title: "Crear Ticket",
        fieldLabel: "Digite para buscar el contacto",
        add: "Agregar",
        buttons: {
          ok: "Guardar",
          cancel: "Cancelar",
      ...
      messagesAPI: {
        ...
        API: {
          ...
          instructions: {
            ...
            comments1:
              "Antes de enviar mensajes, es necesario el registro del token vinculado a la conexión que enviará los mensajes. <br />Para realizar el registro acceda al menú 'Conexiones', haga clic en el botón editar de la conexión e inserte el token en el campo correspondiente.",
            comments2:
          ...
          text: {
            ...
            instructions:
              "A continuación se presenta la lista de información necesaria para el envío de mensajes de texto:",
          },
          media: {
            title: "2. Mensajes con Archivo",
            instructions:
              "A continuación se presenta la lista de información necesaria para el envío de mensajes con archivo:",
          },
        },
      },
      notifications: {
      ...
      campaigns: {
        ...
        dialog: {
          ...
          help: "Utilice variables como {nome}, {numero}, {email} o defina variables personalizadas.",
          form: {
            name: "Nombre",
            message1: "Mensaje 1",
            message2: "Mensaje 2",
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Eliminar",
          deleteMessage:
            "¿Está seguro? ¡Esta acción no se puede revertir! Las atenciones de esta cola continuarán existiendo, pero no tendrán más ninguna cola asignada.",
        },
      },
      queue: {
        queueData: "Datos",
      ...
      queueIntegration: {
        ...
        confirmationModal: {
          deleteTitle: "Eliminar",
          deleteMessage:
            "¿Está seguro? ¡Esta acción no se puede revertir! y será removida de las colas y conexiones vinculadas",
        },
      },
      users: {
        title: "Usuarios",
      ...
      schedules: {
        ...
        confirmationModal: {
          deleteTitle: "¿Está seguro que quiere eliminar esta Programación?",
          deleteMessage: "Esta acción no se puede revertir.",
        },
        table: {
          contact: "Contacto",
      ...
      tags: {
        title: "Etiquetas",
        confirmationModal: {
          deleteTitle: "¿Está seguro que quiere eliminar esta Etiqueta?",
          deleteMessage: "Esta acción no se puede revertir.",
        },
        table: {
          id: "ID",
      ...
      tagsKanban: {
        ...
        confirmationModal: {
          deleteTitle: "¿Está seguro que quiere eliminar este Tablero?",
          deleteMessage: "Esta acción no se puede revertir.",
        },
        table: {
          name: "Nombre",
      ...
      settings: {
        ...
        settings: {
          ...
          LGPD: {
            ...
            obfuscatePhoneUser: "Ofuscar número telefónico para usuarios",
            enabled: "Habilitado",
            disabled: "Deshabilitado",
          },
        },
      ...
      messagesInput: {
        placeholderPrivateMessage:
          "Escriba un mensaje o presione / para respuestas rápidas",
        placeholderOpen:
          "Escriba un mensaje o presione / para respuestas rápidas",
        placeholderClosed:
      ...
      backendErrors: {
        ...
        ERR_NO_DEF_WAPP_FOUND:
          "Ningún WhatsApp predeterminado encontrado. Verifique la página de conexiones.",
        ERR_WAPP_NOT_INITIALIZED:
          "Esta sesión de WhatsApp no fue inicializada. Verifique la página de conexiones.",
        ERR_WAPP_CHECK_CONTACT:
          "No fue posible verificar el contacto de WhatsApp. Verifique la página de conexiones",
        ERR_WAPP_INVALID_CONTACT: "Este no es un número de WhatsApp válido.",
        ERR_WAPP_DOWNLOAD_MEDIA:
          "No fue posible descargar medios de WhatsApp. Verifique la página de conexiones.",
